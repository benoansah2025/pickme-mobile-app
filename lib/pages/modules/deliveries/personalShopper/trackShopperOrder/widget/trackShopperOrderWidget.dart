...
Widget trackShopperOrderWidget({
    ...
    child: SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          _layout(
            time: "10:00 am",
            text: "Shopper is purchasing items",
            check: true,
          ),
          _layout(
            time: "10:30 am",
            text: "Shopper is heading towards you",
            check: true,
          ),
          _layout(
            time: "10:30 am",
            text: "Shopper has arrived at your location",
            check: true,
          ),
          _layout(
            time: "10:30 am",
          ...
          const SizedBox(height: 30),
          Text("Communication", style: Styles.h4BlackBold),
          const SizedBox(height: 10),
          Text(
            "Kindly call the shopper and provide additional information needed to complete the shopping Eg: where to purchase your items and confirmation of prices",
