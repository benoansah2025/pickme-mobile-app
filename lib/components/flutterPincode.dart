...
class PinCodeWidget extends StatefulWidget {
  const PinCodeWidget({
    ...
    this.deleteIconSize,
    this.enterIconSize,
    this.enterIconData = CupertinoIcons.arrow_right_to_line,
  });
  ...
  final double? enterIconSize;
  final IconData? enterIconData;
...
class PinCodeState<T extends PinCodeWidget> extends State<T> {
  ...
  Widget body(BuildContext context) {
    ...
    final enterIconImage = Icon(
      widget.enterIconData,
      color: widget.deleteIconColor,
      size: widget.enterIconSize,
    );
    return MeasureSize(
      onChange: (size) {
              ...
              child: Padding(
                  ...
                  child: ListView(
                    ...
                    children: List.generate(widget.maxPinLength, (index) {
                      ...
                      // Check if the current index is less than the length of the PIN entered
                      if (index < pin.length) {
                        return Padding(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: widget.filledIndicatorColor, // Filled color for entered PIN length
                            ),
                          ),
                        );
                      } else {
                        return Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              border: Border.all(color: widget.filledIndicatorColor), // Outline for remaining spaces
                              color: Colors.transparent, // Empty circle for remaining spaces
                            ),
                          ),
                        );
                      }
